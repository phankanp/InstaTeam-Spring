package phan.spring.hibernate.instateam.model;
...
public class Project implements Comparable<Project> {
    ...
    @NotNull
    @Size(min = 1, max = 25, message = "Please enter a valid name between {min} and {max} characters")
    @Column
    private String name;

    @NotNull
    @Size(min = 1, max = 1000, message = "Please enter a valid name between {min} and {max} characters")
    @Column
